...
void loop() {
  ...
  display_symbol(); //  LAB6 this line should be replaced with a callto AVR
  delay(TEST_DELAY);
  ...
  display.setSegments(SEG_DONE); //  LAB6 this line should be replaced with a callto AVR
  delay(TEST_DELAY);

  display_symbol();// LAB6 -- this line needs several changes
  delay(TEST_DELAY);
}
